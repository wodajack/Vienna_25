...
# Get custom function
devtools::source_url('https://raw.githubusercontent.com/kwartler/Vienna_24/refs/heads/main/Summer_2024/Day2/Z_beta_scripts/beta_renderLogisticForm_with_aesthetics.R')
